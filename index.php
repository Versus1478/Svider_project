...
<body>
  ...
  <?php
  $agency_name = "Digital Media Agency";
  $headline = "We Boost Your Website Traffic";
  $description = "This template is brought to you by TemplateMo website. Feel free to use this for a commercial purpose. You are not allowed to redistribute the template ZIP file on any other template website. Thank you.";
  $quote_link = "#contact";
  $image_path = "assets/images/slider-dec-v3.png";
  ?>
                  ...
                  <div class="row">
                      <div class="col-lg-6 align-self-center">
                          <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                              <div class="row">
                                  <div class="col-lg-12">
                                      <h6><?= htmlspecialchars($agency_name) ?></h6>
                                      <h2><?= htmlspecialchars($headline) ?></h2>
                                      <p><?= nl2br(htmlspecialchars($description)) ?></p>
                                  </div>
                                  <div class="col-lg-12">
                                      <div class="border-first-button scroll-to-section">
                                          <a href="<?= htmlspecialchars($quote_link) ?>">Free Quote</a>
                                      </div>
                                  </div>
                              </div>
                          </div>
                      ...
                      <div class="col-lg-6">
                          <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                              <img src="<?= htmlspecialchars($image_path) ?>" alt="Banner Image">
                          </div>
                      </div>
                  </div>
              </div>
